...
%% ================= 配置 =================
gt_dir = 'E:\MATLAB程序\1.3\1.3.2\TESTPC1';
denoise_dir = 'E:\MATLAB程序\1.3\1.3.2\TESTPC1\消融实验';

excel_out = fullfile(denoise_dir, 'TESTPC1_消融实验评价结果.xlsx');
...
paper_excel_out = fullfile(gt_dir, 'TESTPC1_消融实验_论文表格格式.xlsx');
