...
%% ================= 配置 =================
gt_dir = 'E:\MATLAB程序\1.3\1.3.2\TESTPC2';
denoise_dir = 'E:\MATLAB程序\1.3\1.3.2\TESTPC2\消融实验';

excel_out = fullfile(denoise_dir, 'TESTPC2_消融实验评价结果.xlsx');

dist_thresh = 0.01;   % KDTree 匹配距离阈值
lambda = 5;         % ScoreProduct 权重
...
paper_excel_out = fullfile(gt_dir, 'TESTPC2_消融实验_论文表格格式.xlsx');
