...
CONFIG = {
    "input_dir": r"E:\MATLAB程序\1.3\1.3.2\TESTPC3",
    "output_dir": r"E:\MATLAB程序\1.3\1.3.2\TESTPC3\消融实验",
...
def process_one_file(input_path):
    ...
    mask_A = get_wavelet_mask(points_work)
    print("模块 A 小波完成")

    mask_B = get_distance_mask(points_work)
    print("模块 B 距离完成")

    mask_C = get_normal_mask(points_work)
    print("模块 C 法向完成")
